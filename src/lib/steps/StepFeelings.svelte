<script>
    ...
    async function handleInput(userInput) {
        ...
        displayMessage = "";
        try {
            const motivationdata = await fetchMotivationClassification(userInput);
            ...
            displayMessage = `User identified to feel ${mentalState}`;
...
>
    <div class="space-y-3">
        ...
        >
            Please explain how you actually feel about the task in sentence</p>
    </div>
    ...
    <div class="w-full">
        <InputBox onSend={handleInput} placeholder="I feel ..." />
    </div>
